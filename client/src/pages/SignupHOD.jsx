  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.requiresOTP) {
        ...
        setSuccess('HOD registration successful! You can now login.')
        setTimeout(() => {
      ...
      >
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          >
            ...
            <p className="text-gray-600">Head of Department Account</p>
          </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {loading ? 'Processing...' : showOTP ? 'Verify & Register' : 'Register as HOD'}
            </button>
          </form>

          <div className="mt-6 text-center">
            <p className="text-gray-600">
              <Link to="/signup-staff" className="text-blue-600 hover:text-blue-700 mr-4">Staff Signup</Link>
